...
export const EVENT_COVERAGE_REGISTRY: EventCoverage[] = [
  ...
  {
    event: 'PROFILE_LIKE', status: 'READY',
    validator: true, orchestrator: true, factory: true,
    service: false, repository: false, antiFarm: true, tests: true,
    deployedAt: '2026-06', notes: 'Bloco 5 — integração completa',
  },
  {
    event: 'MESSAGE_REPLY', status: 'READY',
    validator: true, orchestrator: true, factory: true,
    service: false, repository: false, antiFarm: true, tests: true,
    deployedAt: '2026-06', notes: 'Bloco 5 — integração completa',
  },
  {
    event: 'MISSION_COMPLETED', status: 'READY',
    validator: true, orchestrator: true, factory: true,
    service: true, repository: false, antiFarm: true, tests: true,
    deployedAt: '2026-06', notes: 'Bloco 5 — MissionService + fragmentos antes do Engine',
  },
  {
    event: 'MATCH_CREATED', status: 'READY',
    validator: true, orchestrator: true, factory: true,
    service: true, repository: false, antiFarm: true, tests: true,
    deployedAt: '2026-06', notes: 'Bloco 5 — MatchService (ADR-001), Tree + Prestige ativos',
  },
  // Reservados — Bloco 6+
