...
export default function HomeScreen({ navigation }: Props) {
  ...
  useEffect(() => {
    if (activeTab === 'emalta' && mostVisited.length === 0) {
      loadMostVisited();
    }
  }, [activeTab]);
      ...
      <ScrollView showsVerticalScrollIndicator={false} stickyHeaderIndices={[1]}>
        ...
        {activeTab === 'conversas' && (
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtitle}>
              Conecte-se com perfis e inicie conversas reais!
            </Text>
            <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  bellButton: {
    ...
    borderWidth: 1, borderColor: colors.grayDark, position: 'relative',
  },
  ...
  tab: {
    ...
    borderColor: colors.grayDark, backgroundColor: colors.surface,
  },
  ...
  mostVisitedBanner: {
    ...
    backgroundColor: colors.gold + '22', borderRadius: borderRadius.md,
    padding: spacing.md, borderWidth: 1, borderColor: colors.gold + '44',
  },
  mostVisitedBannerText: {
    color: colors.gold, fontSize: fonts.sizes.md,
  ...
  emptyContainer: {
    ...
    paddingTop: 80, paddingHorizontal: spacing.xl, gap: spacing.md,
  },
